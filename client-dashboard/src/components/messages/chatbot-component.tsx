...
export function ChatbotComponent({ projectId }: ChatbotComponentProps) {
  ...
  useEffect(() => {
    const initChatbot = async () => {
      try {
        ...
        addMessage('Przepraszam, wystąpił błąd podczas inicjalizacji asystenta. Spróbuj odświeżyć stronę.', 'bot')
      }
    }
